...
(function () {
  ...
  function run() {
    var sel = ".section__head,.route,.svc,.mini,.proof,.stat,.grp__col,.rep__card,.rep__body,.tl-item,.flow__step,.philo,.timeline,.brands,.campus,.region-label,.city-chips,.found,.gcard";
